...
(function(a) {
    a.Slider = function(g, f) {
        ...
        m.find("img[data-src]").each(function() {
            ...
            r.loaded = false;
            // TODO 此处的空白默认图片
            var s = $(r).attr("src", "./img/blank.png").addClass("loading").one("do-load",
            function() {
                if (r.loaded) {
                    return
                }
...
(function(c) {
  ...
  (function(g, e, h) {
        ...
        // TODO 此处的播放需要删除 @hujxb
        var e = d.Path($("<div></div>").appendTo("#j-focusPic").hide(), {
            button: [[[0, 43], "i-menu", "播放", "#"], [[20, -41], "i-ipad", "ipad版", "#"], [[60, -23], "i-iphone", "iphone版", "#"], [[76, 14], "i-tv", "TV版", "#"], [[68, 51], "i-pc", "乐视网络电视", "#"]]
        });
        ...
        var h = d.slider("#j-focusBtns", {
            ...
            // 修改了默认缩略图的尺寸 70 -> 50
            sliderItemWidth: 50,
            // TODO 此处的记数需要调整，乐视默认始终显示10条，我们的插件不是固定的
            sliderItemCount: 8,
            clipSize: 5,
            stepSize: 5,
            onSlidBegin: function(o, n) {
        ...
        // 修改了原先的jQuery选择器 Aflash -> slider
        $(".slider").mouseover(function(n) {
            m.stop()
        }).mouseout(function(n) {
            m.start()
        });
